...
## Introdução: Váriaveis positivas
	
- Definindo váriaveis positivas: dados nulos ou positivos, quais retornarão variável resposta tambêm positiva.
- Precisam ser positivos para estarem dentro do dominio e imagem das distribuições que serão supostas.
- Váriaveis positivam emglobam númros interiros e continuos.
	
## Exemplos de distribuições e suas ultilizações

- Poisson: dados de contagem, poucos zeros, números naturais;
- Binomial: poucos zero, números naturais;
- Binomial Negativa: muitos zeros, números inteiros;
- Weibull: base de dados pequena, valores continuos, reais positivos;
- Birnbaum-Saunders: dados assimétricos, poucos zeros, números reais;
- Gama: dados assimétricos, poucos zeros, números reais;
- Normal-Inversa: dados assimétricos, poucos zeros, números reais;
...
$$ Y_{ij} = \alpha_i +  \alpha_i\beta\cos(f(x_{ij}))$$
